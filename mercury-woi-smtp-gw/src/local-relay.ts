...
export async function startSmtpServer(port: number, bindAddress = '127.0.0.1'): Promise<SMTPServer> {
...
export async function startPop3Server(port: number, bindAddress = '127.0.0.1'): Promise<net.Server> {
  ensureQueueDir();
